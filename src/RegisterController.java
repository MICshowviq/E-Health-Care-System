...
public class RegisterController implements Initializable {
    ...
    public void RegistrationCompletedButtonPushed(ActionEvent event) throws Exception
    {
        Parent RegistrationCompletedParent = FXMLLoader.load(getClass().getResource("RegistrationCompleted.fxml"));
        Scene RegistrationCompletedScene = new Scene(RegistrationCompletedParent);
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(RegistrationCompletedScene);
        window.show();
    }
